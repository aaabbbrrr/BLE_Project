#include <stdbool.h>    //bool datatype, which can have 'True' and 'False' values...or '1' and '0'
#include <stdint.h>     //defines integer datatypes, i.e., int8_t, int16_t, and so on...
#include <string.h>     //Functions related to string processing
#include <stdio.h>
#include "sdk_config.h"    //Configures the SDK static settings of an application
#include "nrf.h"
#include "ble.h"
#include "ble_gatt.h"
#include "ble_hci.h"
...
// --------- // I commented the following code
//static adv_scan_type_seclection_t   m_adv_scan_type_selected = SELECTION_CONNECTABLE; 
...
static void on_ble_gap_evt_connected(ble_gap_evt_t const * p_gap_evt)
{
    ...
    // I changed the m_output_power_selected to -20 directly
    err_code = sd_ble_gap_tx_power_set(BLE_GAP_TX_POWER_ROLE_CONN, m_conn_handle, -20);
...
static void advertising_data_set(void)
{
   ...
   // memset(&adv_params, 0, sizeof(_adv_params));   //  This one...failed...
     ble_gap_adv_params_t adv_params =
    {
      ...
      // BLE_GAP_ADV_TYPE_NONCONNECTABLE_SCANNABLE_UNDIRECTED
       ...
       // .type = BLE_GAP_ADV_TYPE_NONCONN_IND,
        ...
        .interval      = NON_CONNECTABLE_ADV_INTERVAL,// ADV_INTERVAL,
        .duration      = 0,
...
// -------------I commented following if block
  ...
  if(m_adv_scan_phy_selected == SELECTION_CODED_PHY)
    {
        ...
        else if(m_adv_scan_type_selected == SELECTION_NON_CONNECTABLE)
        {
            ...
            // ------- I commented this line and modified next...
...
static void advertising_start(void)
{
  ...
  ret_code_t err_code;
   ...
   // err_code = sd_ble_gap_tx_power_set(BLE_GAP_TX_POWER_ROLE_ADV, m_adv_handle, m_output_power_selected);
    err_code = sd_ble_gap_tx_power_set(BLE_GAP_TX_POWER_ROLE_ADV, m_adv_handle, -20);
